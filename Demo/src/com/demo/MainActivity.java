...
import com.demo.support.PassData;
...
{	
    ...
    public void goToDictionary(View v)
    {
    ...
    {
    	PassData ps = (PassData) getApplication();
    	
		ps.setOrigin("New Origin");
		ps.setDestination("New Destination");
